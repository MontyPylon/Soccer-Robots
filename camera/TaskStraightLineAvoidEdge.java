...
public class TaskStraightLineAvoidEdge implements Const {
	
	Logger log = Logger.getLogger(TaskStraightLineAvoidEdge.class);
    public static final int dbg = 4;
    public static final String dname = "TSLAE";
